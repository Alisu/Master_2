 ...
 * </p>
 * <ul>
 *   <li>{@link memo.impl.PersonImpl#getAge <em>Age</em>}</li>
 *   <li>{@link memo.impl.PersonImpl#getHas <em>Has</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PersonImpl extends NamedElementImpl implements Person {
	 ...
	 * @generated
	 */
	public EList<Automible> getHas() {
		if (has == null) {
			has = new EObjectResolvingEList<Automible>(Automible.class, this, MemoPackage.PERSON__HAS);
		}
		return has;
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case MemoPackage.PERSON__HAS:
				getHas().clear();
				getHas().addAll((Collection<? extends Automible>)newValue);
				return;
		}
