...
public class MemoPackageImpl extends EPackageImpl implements MemoPackage {
	 ...
	 * @generated
	 */
	public EAttribute getAutomobile_TypeVoiture() {
	...
	public void createPackageContents() {
		...
		createEAttribute(automobileEClass, AUTOMOBILE__TYPE_VOITURE);
	...
	public void initializePackageContents() {
		...
		initEAttribute(getAutomobile_TypeVoiture(), this.getAutomobileType(), "typeVoiture", null, 0, 1,
				Automobile.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
