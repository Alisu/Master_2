 ...
 * </p>
 * <ul>
 *   <li>{@link tp1bis.maps.impl.RoadImpl#getBorder <em>Border</em>}</li>
 *   <li>{@link tp1bis.maps.impl.RoadImpl#getMeet <em>Meet</em>}</li>
 *   <li>{@link tp1bis.maps.impl.RoadImpl#getName <em>Name</em>}</li>
 *   <li>{@link tp1bis.maps.impl.RoadImpl#getLength <em>Length</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class RoadImpl extends MinimalEObjectImpl.Container implements Road {
	...
	public EList<PublicSpace> getBorder() {
		if (border == null) {
			border = new EObjectWithInverseResolvingEList.ManyInverse<PublicSpace>(PublicSpace.class, this,
					NewPackage1Package.ROAD__BORDER, NewPackage1Package.PUBLIC_SPACE__BORDERD_BY);
		}
		return border;
	}
	...
	public EList<Road> getMeet() {
		if (meet == null) {
			meet = new EObjectResolvingEList<Road>(Road.class, this, NewPackage1Package.ROAD__MEET);
		}
		return meet;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		...
		case NewPackage1Package.ROAD__BORDER:
			return getBorder();
		case NewPackage1Package.ROAD__MEET:
			return getMeet();
