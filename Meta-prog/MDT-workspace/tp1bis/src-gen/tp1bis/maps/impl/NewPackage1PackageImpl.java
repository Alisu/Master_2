...
public class NewPackage1PackageImpl extends EPackageImpl implements NewPackage1Package {
	 ...
	 * @see tp1bis.maps.NewPackage1Package#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public EReference getPublicSpace_BorderdBy() {
	...
	public void createPackageContents() {
		...
		createEReference(publicSpaceEClass, PUBLIC_SPACE__BORDERD_BY);
	...
	public void initializePackageContents() {
		...
		initEReference(getRoad_Border(), this.getPublicSpace(), this.getPublicSpace_BorderdBy(), "border", null, 0, -1,
				Road.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getRoad_Meet(), this.getRoad(), null, "meet", null, 0, -1, Road.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEAttribute(getRoad_Name(), ecorePackage.getEString(), "name", null, 0, 1, Road.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getPublicSpace_BorderdBy(), this.getRoad(), this.getRoad_Border(), "borderdBy", null, 1, -1,
