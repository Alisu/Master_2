...
public class NewPackage1Switch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case NewPackage1Package.PUBLIC_SPACE: {
