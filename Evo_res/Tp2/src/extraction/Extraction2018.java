package extraction;
	...
	public class Extraction2018 {
			...
			public static void main(String[] args) throws SecurityException, ClassNotFoundException, IOException, IllegalArgumentException, IllegalAccessException {
				...
				dFile.setEntityList(listeComplete);
				createFileFromList("concrete2018v2.txt", dFile.getEntityList());
				...
				d4.createTable(2);
				d4.afficheTable();
				d4.ecrireTable("formatConc2018v2.rcft");
				d4.ecrireTable("formatConc2018v2.csv");}
		}